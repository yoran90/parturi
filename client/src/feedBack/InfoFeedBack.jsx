...
const InfoFeedBack = ({ setOpenFeedBack, onCloseInfo }) => {
  return (
    <div className='fixed bottom-1 left-1 right-1 z-50'>
      <div className='bg-white shadow-xl w-full max-w-lg border border-slate-300 rounded py-10 px-3 relative max-h-[98vh] md:overflow-hidden overflow-y-scroll scrollbarStyle'>
