    ...
    <>
      {!successMessage && (
        <div className='fixed top-0 right-0 left-0 bottom-0 flex items-center justify-center z-50 bg-black/60'>
          <div className='w-[98%] md:max-w-[75%] lg:max-w-[70%] xl:max-w-[60%] 2xl:max-w-[50%] md:mx-0 mx-1 bg-white rounded shadow-lg md:px-12 md:py-12 py-8 h-[98vh] md:mt-0 mt-12 overflow-y-scroll scrollbarStyle px-3  md:mb-0 mb-12  relative'>
