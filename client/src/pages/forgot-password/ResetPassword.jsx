        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4.5 text-sm mt-6'>
          <div className='flex flex-col gap-1.5'>
            ...
            <div className='border border-slate-300 flex items-center justify-between py-2 px-3 rounded'>
              <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} className='w-full  border-none outline-none' placeholder='Kirjoita sähköpostiosoitteesi' />
              {
                showPassword ? (
          ...
          <div className='flex flex-col gap-1.5'>
            ...
            <div className='border border-slate-300 flex items-center justify-between py-2 px-3 rounded'>
              <input type={showConfirmPassword ? "text" : "password"} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className='w-full border-none outline-none' placeholder='Kirjoita sähköpostiosoitteesi' />
              {
                showConfirmPassword ? (
