...
const Register = () => {
  ...
  return (
     <div className='w-full flex flex-col justify-center bg-black/90 relative'>
      ...
      <div className='flex md:w-full items-center justify-center md:px-6 md:gap-6 min-h-screen pb-24 md:pb-12'>
        <div className='md:w-[50%] w-full md:p-0 p-4'>
        ...
        {/* image */}
        <div className='w-[50%] h-[60vh] md:flex hidden border border-slate-300 rounded'>
      ...
      {/* sosial medi */}
      <div className='flex items-center justify-center text-white py-2 px-4 absolute md:bottom-10 bottom-20 left-50 right-50'>
