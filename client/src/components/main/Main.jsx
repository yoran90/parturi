...
const Main = () => {
  ...
  return (
    <div className='relative w-full md:h-[85vh] h-[55vh] overflow-hidden'>
      ...
      <div className="absolute md:top-100 lg:top-100 top-50 left-0 right-0 flex justify-between px-4 md:px-8" style={{ zoom: '0.9'}}>
