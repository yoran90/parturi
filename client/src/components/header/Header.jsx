...
const Header = () => {
  ...
  return (
    <>
      <div className='md:flex hidden items-center justify-between bg-black border-t-2 border-slate-800'>
      ...
      {/* for mobile screen */}
      <div className='md:hidden relative flex items-center justify-between bg-black border-t-2 border-slate-800'>
        <div className='bg-black p-2'> 
          <img src={headerLogo} alt="Header Logo" className='w-[100px] h-[50px]' />
        </div>
        ...
        <div className={`${showTheHeader ? 'absolute flex flex-col bg-black z-100 top-[66px] right-0 w-full pl-3.5 py-6' : 'hidden'}`}>
          <Link to={'/'}>
            <button onClick={clickTheMenuShowHeader} className='text-white cursor-pointer text-sm p-2 hover:bg-slate-800'>Etusivu</button>
          </Link>
          <Link to={'/palvelut'}>
            <button onClick={clickTheMenuShowHeader} className='text-white cursor-pointer text-sm p-2 hover:bg-slate-800'>Palvelut/Hinta</button>
          </Link>
          <Link to={'/galaria'}>
